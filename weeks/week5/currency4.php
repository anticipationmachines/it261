...
<body>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        <fieldset>
            ...
            <ul>
                <li><input type="radio" id="currency" name="currency" value="0.017" <?php if(isset($_POST['currency']) && $_POST['currency'] == 0.017) echo 'checked="checked"' ;?>> Rubles</li>
            ...
            <input id="submit" type="submit" value="Convert it">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($errors) && isset($_POST['name'], $_POST['email'], $_POST['amount'], $_POST['currency'], $_POST['bank'])) {
            ...
            if ($dollars > 1000) {
                ...
                <div class="rich">
                    <p>Rich but happy???</p>
                    <img  class="sad" src="https://fritzcodes.anticipationmachines.com/it261/weeks/week5/images/sad.gif" alt="happy gif">
                </div>';
            } else {
                echo '
                <div class="poor">
                    <p>Poor but happy!!!</p>
                    <img  class="happy" src="https://fritzcodes.anticipationmachines.com/it261/weeks/week5/images/happy.gif" alt="sad gif">
                </div>';
            }
...
<footer>
        <p>HTML Validation: <a href="https://validator.w3.org/nu/?doc=https%3A%2F%2Ffritzcodes.anticipationmachines.com%2Fit261%2Fweeks%2Fweek5%2Fcurrency4.php" target="_blank">Validate HTML</a></p>
        <p>CSS Validation: <a href="https://jigsaw.w3.org/css-validator/validator?uri=https%3A%2F%2Ffritzcodes.anticipationmachines.com%2Fit261%2Fweeks%2Fweek5%2Fcurrency4.php&profile=css3svg&usermedium=all&warning=1&vextwarning=&lang=en" target="_blank">Validate CSS</a></p>
    </footer>
</body>
</html>
