...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_POST['privacy'])) {
        ...
        if (!empty($first_name && $last_name && $email && $gender_questions && $phone && $fav_zelda_games && $regions && $comments && $privacy && preg_match('/^[0-9]{3}-[0-9]{3}-[0-9]{4}$/', $_POST['phone'])))
        {
...
<body>
    ...
    <form action="<?php echo htmlspecialchars(
        ...
        <fieldset>
            ...
            <ul>
                <li><input type="radio" name="gender_questions" value="silly" <?php if (isset($_POST["gender_questions"]) && $_POST["gender_questions"] == "silly") {
                    echo 'checked= "checked"';
                } ?>> silly</li>

                <li><input type="radio" name="gender_questions" value="fine i guess" <?php if (isset($_POST["gender_questions"]) && $_POST["gender_questions"] == "fine i guess") {
                    echo 'checked= "checked"';
                } ?>> fine i guess</li>

                <li><input type="radio" name="gender_questions" value="annoying" <?php if (isset($_POST["gender_questions"]) && $_POST["gender_questions"] == "annoying") {
                    echo 'checked= "checked"';
                } ?>> annoying</li>
            ...
            <textarea name="comments" placeholder="all negative comments will be incinerated"><?php if (isset($_POST["comments"])) {
