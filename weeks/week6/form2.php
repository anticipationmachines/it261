...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    {
        $my_return = "";
        if (!empty($fav_zelda_games)) {
            $my_return = implode(",", $fav_zelda_games);
        }
        return $my_return;
    } //end of function
    ...
    if (
        ...
        !empty($last_name) &&
        !empty($email) &&
        !empty($gender_questions) &&
        !empty($phone) &&
        !empty($fav_zelda_games) &&
        !empty($regions) &&
        !empty($comments) &&
        !empty($privacy)
    ) {
        $to = "fritzrodriguezart@gmail.com";
        ...
        first name: ' .
            ...
            "   " .
            PHP_EOL .
            "thoughts on gender questions on forms: " .
            $gender_questions .
            "   " .
            PHP_EOL .
            "phone number: " .
            ...
            "   " .
            PHP_EOL .
            "favorite zelda games are : " .
            fav_zelda_games($fav_zelda_games) .
            "   " .
            PHP_EOL .
            "region: " .
            $regions .
        ...
        $headers = "From: noreply@fritzcodes.anticipationmachines.com";
        ...
        if (mail($to, $subject, $body, $headers)) {
            ...
            echo "server email permission woes :( " . error_get_last()['message'];
        }
    }
}
?>
