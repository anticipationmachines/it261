...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_POST['privacy'])) {
        ...
        $headers = array(
            'From' => 'noreply@frirod1.dreamhosters.com'
            );
...
$characters['Link'] = 'linkk_The Legend of Zelda';
$characters['Zelda'] = 'zelda_The Legend of Zelda';
$characters['Ganondorf'] = 'ganon_The Legend of Zelda';
$characters['Impa'] = 'impaa_The Legend of Zelda';
$characters['Navi'] = 'navii_Ocarina of Time';
$characters['Epona'] = 'epona_Ocarina of Time';
$characters['Tingle'] = 'tingl_Majoras Mask';
$characters['Skull Kid'] = 'skull_Majoras Mask';
$characters['Tatl and Tael'] = 'tatll_Majoras Mask';
$characters['Vaati'] = 'vaati_The Minish Cap';
$characters['Tetra'] = 'tetra_Wind Waker';
$characters['Midna'] = 'midna_Twilight Princess';
$characters['Zant'] = 'zantt_Twilight Princess';
$characters['Hero\'s Spirit'] = 'spiri_Twilight Princess';
$characters['Ashei'] = 'ashei_Twilight Princess';
$characters['Fyer'] = 'fyerr_Twilight Princess';
$characters['Fi'] = 'fiiii_Skyward Sword';
$characters['Daruk'] = 'daruk_Breath of the Wild';
$characters['Urbosa'] = 'urbos_Breath of the Wild';
$characters['Mipha'] = 'mipha_Breath of the Wild';
$characters['Revali'] = 'reval_Breath of the Wild';

// $characters['Link'] = 'linkk_The courageous hero and protagonist of "The Legend of Zelda" series, known for wielding the Master Sword';
// $characters['Zelda'] = 'zelda_The titular princess of Hyrule, often possessing magical abilities';
// $characters['Ganondorf'] = 'ganon_The primary antagonist, a powerful and recurring villain who seeks to dominate Hyrule using the Triforce';
// $characters['Impa'] = 'impaa_A loyal and skilled Sheikah warrior who serves as a guardian and advisor to Zelda and Link';
// $characters['Navi'] = 'navii_A fairy companion iconic for the catchphrase "Hey, listen!"';
// $characters['Epona'] = 'epona_A trusted horse companion, known for its speed and agility,';
// $characters['Tingle'] = 'tingl_A quirky character often associated with maps and eccentric behavior';
// $characters['Skull Kid'] = 'skull_A mischievous character, manipulated by dark forces';
// $characters['Tatl and Tael'] = 'tatll_Fairy siblings accompanying Link, providing assistance and torn between good and evil';
// $characters['Vaati'] = 'vaati_A wind mage with the power to turn people into Picori';
// $characters['Tetra'] = 'tetra_Initially a pirate captain, revealed as Princess Zelda in disguise';
// $characters['Midna'] = 'midna_A Twilight being, serving as a crucial ally to Link with a unique impish appearance';
// $characters['Zant'] = 'zantt_A powerful sorcerer responsible for spreading Twilight across Hyrule';
// $characters['Hero\'s Spirit'] = 'spiri_A spectral warrior, guiding Link and helping him learn advanced sword techniques';
// $characters['Ashei'] = 'ashei_A skilled warrior and member of the Resistance, contributing to the fight against evil';
// $characters['Fyer'] = 'fyerr_A character operating the cannon, known for a flamboyant personality';
// $characters['Fi'] = 'fiiii_The spirit residing in the Master Sword, providing guidance and information to Link';
// $characters['Daruk'] = 'daruk_A Goron Champion known for strength and bravery';
// $characters['Urbosa'] = 'urbos_A Gerudo Champion, wielding lightning-based abilities ';
// $characters['Mipha'] = 'mipha_A Zora Champion, possessing healing powers';
// $characters['Revali'] = 'reval_A Rito Champion, skilled in archery and known for pride and confidence';
...
$dailyStyle = 'color:' . (
    ($today == 'Sunday') ? '#FFA07A !important' :
    (($today == 'Monday') ? '#FFD700 !important' :
        (($today == 'Tuesday') ? '#98FB98 !important' :
            (($today == 'Wednesday') ? '#87CEEB !important' :
                (($today == 'Thursday') ? '#FFB6C1 !important' :
                    (($today == 'Friday') ? '#FF69B4 !important' : '#FF6347 !important')))))
) . '; display: inline;';