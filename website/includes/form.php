...
<ul>
    <li>
        <input type="radio" name="triforce" value="Wisdom" <?php
            if (isset($_POST["triforce"]) && $_POST["triforce"] == "Wisdom") {
                echo 'checked="checked"';
            }
        ?>> Wisdom
    </li>
    <li>
        <input type="radio" name="triforce" value="Strength" <?php
            if (isset($_POST["triforce"]) && $_POST["triforce"] == "Strength") {
                echo 'checked="checked"';
            }
        ?>> Strength
    </li>
    <li>
        <input type="radio" name="triforce" value="Courage" <?php
            if (isset($_POST["triforce"]) && $_POST["triforce"] == "Courage") {
                echo 'checked="checked"';
            }
        ?>> Courage
    </li>
    ...
    <ul>
    <li>
        <input type="checkbox" name="fav_zelda_games[]" value="Majora's Mask" <?php
            if (isset($_POST["fav_zelda_games"]) && in_array("Majora's Mask", $_POST["fav_zelda_games"])) {
                echo 'checked="checked"';
            }
        ?>> Majora's Mask
    </li>
    <li>
        <input type="checkbox" name="fav_zelda_games[]" value="Ocarina of Time" <?php
            if (isset($_POST["fav_zelda_games"]) && in_array("Ocarina of Time", $_POST["fav_zelda_games"])) {
                echo 'checked="checked"';
            }
        ?>> Ocarina of Time
    </li>
    <li>
        <input type="checkbox" name="fav_zelda_games[]" value="Oracle of Ages/Seasons" <?php
            if (isset($_POST["fav_zelda_games"]) && in_array("Oracle of Ages/Seasons", $_POST["fav_zelda_games"])) {
                echo 'checked="checked"';
            }
        ?>> Oracle of Ages & Seasons
    </li>
    <li>
        <input type="checkbox" name="fav_zelda_games[]" value="Skyward Sword" <?php
            if (isset($_POST["fav_zelda_games"]) && in_array("Skyward Sword", $_POST["fav_zelda_games"])) {
                echo 'checked="checked"';
            }
        ?>> Skyward Sword
    </li>
    <li>
        <input type="checkbox" name="fav_zelda_games[]" value="Wind Waker" <?php
            if (isset($_POST["fav_zelda_games"]) && in_array("Wind Waker", $_POST["fav_zelda_games"])) {
                echo 'checked="checked"';
            }
        ?>> Wind Waker
    </li>
